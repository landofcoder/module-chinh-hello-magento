...
[Magento 2 Chinh Hello Magento](https://landofcoder.com/) extension by LandOfCoder display hello magento 2 text anh more

- Display hello magento 2 text
- module training for magento 2 developer
...
The module is simple to display hello magento text. It is better training magento 2 backend developer.
